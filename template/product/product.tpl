...
<div class="span9">
  ...
  <div class="product-info">
    ...
    <div class="right">
      <div class="description">
        <?php if ($manufacturer) { ?>
        <br><?php echo $text_manufacturer; ?></span> <a href="<?php echo $manufacturers; ?>"><?php echo $manufacturer; ?></a>
        <?php } ?>
        <br><?php echo $text_model; ?></span> <?php echo $model; ?>
		<?php if ($this->config->get('config_display_weight') && $weight) { ?>
		<br><?php echo $text_weight; ?> </span> <?php echo $weight; ?>
		<?php } ?>
		<?php if ($this->config->get('config_display_sku') && $sku) { ?>
		<br><?php echo $text_sku; ?> </span> <?php echo $sku; ?>
		<?php } ?>
		<?php if ($this->config->get('config_display_upc') && $upc) { ?>
		<br><?php echo $text_upc; ?> </span> <?php echo $upc; ?>
		<?php } ?>
		<?php if ($this->config->get('config_display_ean') && $ean) { ?>
		<br><?php echo $text_ean; ?> </span> <?php echo $ean; ?>
		<?php } ?>
		<?php if ($this->config->get('config_display_jan') && $jan) { ?>
		<br><?php echo $text_jan; ?> </span> <?php echo $jan; ?>
		<?php } ?>
		<?php if ($this->config->get('config_display_isbn') && $isbn) { ?>
		<br><?php echo $text_isbn; ?> </span> <?php echo $isbn; ?>
		<?php } ?>
		<?php if ($this->config->get('config_display_mpn') && $mpn) { ?>
		<br><?php echo $text_mpn; ?> </span> <?php echo $mpn; ?>
		<?php } ?>
		<?php if ($this->config->get('config_display_location') && $location) { ?>
		<br><?php echo $text_location; ?> </span> <?php echo $location; ?>
		<?php } ?>		
        <?php if ($reward) { ?>
        <br><?php echo $text_reward; ?></span> <?php echo $reward; ?>
        <?php } ?>
        <br><?php echo $text_stock; ?></span> <?php echo $stock; ?></div>
      <?php if ($price) { ?>
      ...
      <div class="options">
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <b><?php echo $option['name']; ?>:</b>
          <?php foreach ($option['option_value'] as $option_value) { ?>
          <br><input type="radio" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>" />
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <b><?php echo $option['name']; ?>:</b>
          <?php foreach ($option['option_value'] as $option_value) { ?>
          <br><input type="checkbox" name="option[<?php echo $option['product_option_id']; ?>][]" value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>" />
          <label for="option-value-<?php echo $option_value['product_option_value_id']; ?>" style="display: inline;"><?php echo $option_value['name']; ?>
            <?php if ($option_value['price']) { ?>
            (<?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?>)
            <?php } ?>
          </label>
      ...
      <div class="cart">
        ...
        <div><br>&nbsp;&nbsp;&nbsp;<?php echo $text_or; ?>&nbsp;&nbsp;&nbsp;</span></div>
  ...
  <div id="tab-review" class="tab-content">
    ...
    <b><?php echo $entry_rating; ?></b> <br><?php echo $entry_bad; ?></span>&nbsp;
