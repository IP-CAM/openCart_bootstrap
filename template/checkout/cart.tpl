...
<div class="row">
  ...
  <h4 style="margin-left: 2em;"><?php echo $text_next; ?></h4>
  <div class="span9">
  <div class="content" style="overflow:hidden;"> 
    <p><?php echo $text_next_choice; ?></p>
    <table class="radio" style="margin-left: 1em;">
  ...
  <div style="span4 offset8">
    <?/*<br><a class="btn" href="<?php echo $continue; ?>" style="margin-left: 1em;"><?php echo $button_shopping; ?></a>*/?>
    <br><a class="btn btn-large btn-success" href="<?php echo $checkout; ?>" style="margin: 1em;"><i class="icon-shopping-cart icon-white"></i>&nbsp;<?php echo $button_checkout; ?></a>
  </div>  
  </div>
</div>
